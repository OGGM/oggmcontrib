...
print("oggmcontrib: %s, %s" % (oggmcontrib.__version__,
                               oggmcontrib.__file__))
...
extlinks = {'issue': ('https://github.com/OGGM/oggmcontrib/issues/%s', 'GH'),
            'pull': ('https://github.com/OGGM/oggmcontrib/pull/%s', 'PR'),
            }
...
version = oggmcontrib.version.short_version
# The full version, including alpha/beta/rc tags.
release = oggmcontrib.__version__
...
latex_documents = [
  (master_doc, 'oggmcontrib.tex', 'oggmcontrib Documentation',
...
man_pages = [
    (master_doc, 'oggmcontrib', 'oggmcontrib documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'oggmcontrib', 'oggmcontrib documentation',
   author, 'oggmcontrib', 'One line description of project.',
   'Miscellaneous'),
]
